...
import com.embabel.example.dogfood.finance.MarketAnalyst
...
class DataAnalystIntegrationTest {
    ...
    fun `agent runs`() {
        ...
        val agent: Agent = AgentMetadataReader().createAgentMetadata(
            MarketAnalyst(FinanceAnalystProperties()
            ),
        ) as Agent
        ...
        val result = ap.runAgentWithInput(
            ...
            input = UserInput("Generate a market analysis report for Microsoft"),
        )
